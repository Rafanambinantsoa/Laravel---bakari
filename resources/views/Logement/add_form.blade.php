    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="add_form"><i class="fas fa-user"></i><span>Ajout des Maisons</span></a>
                    <a class="nav-link" href="show_logement"><i class="fas fa-user"></i><span>Mes maisons</span></a></li>
                <li class="nav-item">
                    <a class="nav-link" href="user/activation"><i class="fas fa-user-circle"></i><span>Activation compte</span></a>
